  ...
  describe "parse" do
    context "variable binding" do
      it "generates the expected AST when the syntax is correct" do
        ...
        expected_programram = axal_prog.new
        expected_programram.expressions << var_binding

        parser = Parser.new(tokens_from_source("var_binding_ok_1.axal"))
        parser.parse

        parser.ast.should eq(expected_programram)
      end
    ...
    context "standalone identifier" do
      it "generates the expected AST" do
        ...
        expected_programram = axal_prog.new
        expected_programram.expressions << var_binding
        expected_programram.expressions << ident
    ...
    context "standalone number" do
      it "generates the expected AST" do
        expected_programram = axal_prog.new
        expected_programram.expressions << axal_num.new(1991.0)
        expected_programram.expressions << axal_num.new(7.0)
        expected_programram.expressions << axal_num.new(28.28)
    ...
    context "standalone string" do
      it "generates the expected AST" do
        expected_programram = axal_prog.new
        expected_programram.expressions << axal_str.new("a string")
        expected_programram.expressions << axal_str.new("another string")
    ...
    context "standalone boolean" do
      it "generates the expected AST" do
        expected_programram = axal_prog.new
        expected_programram.expressions << axal_bool.new(true)
        expected_programram.expressions << axal_bool.new(false)
    ...
    context "boolean expressions" do
      it "generates the expected AST for 1 == 1" do
        ...
        expected_programram.expressions << comparison_op
      ...
      it "generates the expected AST for true != false" do
        ...
        expected_programram.expressions << not_eq_op
    ...
    context "standalone nil" do
      it "generates the expected AST" do
        expected_programram = axal_prog.new
        expected_programram.expressions << axal_nil.new
    ...
    context "unary operators" do
      it "generates the expected AST" do
        ...
        expected_programram.expressions << minus_op_1
        expected_programram.expressions << minus_op_2
        expected_programram.expressions << bang_op
    ...
    context "binary operators" do
      it "generates the expected AST for 2 + 2" do
        expected_programram = axal_prog.new
        plus_op = axal_binary_op.new(TokenKind::PLUS, axal_num.new(2.0), axal_num.new(2.0))
        expected_programram.expressions << plus_op
    ...
    context "mixed operators" do
      it "generates the expected AST for -10 + 2 + 2 * 3 / 3" do
        ...
        expected_programram.expressions << plus_op_2
    ...
    context "logical operators" do
      it "generates the expected AST for true and false" do
        ...
        expected_programram.expressions << and_op
      ...
      it "does generate the expected AST for true or false" do
        ...
        expected_programram.expressions << or_op
    ...
    context "grouped expressions" do
      it "generates the expected AST for (3 + 4) * 2" do
        ...
        expected_programram.expressions << multiplication_op
    ...
    context "return" do
      it "generates the expected AST" do
        ...
        expected_programram = axal_prog.new
        expected_programram.expressions << ret
    ...
    context "conditionals" do
      it "generates the expected AST for a IF THEN conditional" do
        ...
        expected_programram.expressions << var_binding_outer
        expected_programram.expressions << conditional
      ...
      it "does generate the expected AST for a IF THEN ELSE conditional" do
        ...
        expected_programram.expressions << var_binding_1
        expected_programram.expressions << var_binding_2
        expected_programram.expressions << conditional
      ...
      it "does generate the expected AST for a IF THEN ELSE IF conditional" do
        ...
        expected_programram.expressions << var_binding_1
        expected_programram.expressions << var_binding_2
        expected_programram.expressions << conditional_outer
